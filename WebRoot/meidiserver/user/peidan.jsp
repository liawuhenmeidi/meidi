...
<div class="s_main">
    ...
    <!--  头 单种类  -->
    <div class="s_main_tit"><span class="qiangdan"><a href="chaxun_peidan.jsp">我要查询</a></span><span class="qiangdan"><a
            href="welcom.jsp">返回</a></span><span class="qiangdan"><a href="server.jsp?method=quit">退出</a></span></div>
            ...
            <tr <%=col %>>
                ...
                <td align="left">
                    <table>
                        ...
                        %>
                        <tr>
                            <td><%=categorymap.get(Integer.valueOf(op.getCategoryId())).getName()%>
                            </td>
                        </tr>
                        <%
                                    }
