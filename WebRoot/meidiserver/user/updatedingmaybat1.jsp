...
<script type="text/javascript">
 ...
 function initproduct(){
	    initproductSerch("#category","#ordertype0");
	    initproductSerch("#category","#dingmatype");
 ...
 function addrow(str1){
	...
	var type = str1.sendType == null || str1.sendType == undefined ? "":str1.sendType;
	var count = str1.count == null || str1.count == undefined ? 1:str1.count;
	...
	var str = "";
	    str += '<div id="produc'+row+'" name="produc">'+
               ...
               ' <td width="10%" class=""><input type="text"  id="orderproductNum'+row+'" value="'+count+'" name="orderproductNum'+row+'" value="1" style="width:50%"/></td> '+
               ' <td width="10%" class="center"><input type="button"   value="+" onclick="add(orderproductNum'+row+')"/></td> '+ 
               ' <td width="10%" class="center"><input type="button"   value="-" onclick="subtraction(orderproductNum'+row+') " /></td> '+ 
               '<td width="10%" class="center"><input type="button"   color= "red"  value="删除" onclick="deletes(produc'+row+','+row+')"/></td>'+
               ' </tr>'+
               '<tr></tr>'+
               '<table>'+  
               ' <hr>' + 
        ...
        initproductSerch("#category","#ordertype"+row);
        row++; 
        }	
...
<table style="width:100% ">
  ...
  <tr>  
    ...
    <td width="50%" class=""><input class="date" type="text" name="saledate" placeholder="必填"  id="serviceDate"  value="<%=order.getSaleTime() %>" readonly="readonly" style="width:90% "></input>   </td>
  ...
  <tr>
    ...
    <td width="50%" class=""><input type="text"  id="sailId" name="sailId" value="<%=order.getSailId() %>" style="width:90% " /></td>
    <td width="25%" class="center"></td>
  </tr>
  <tr>
  ...
  <select class="category" name="category" id="category" style="width:95% ">
  
  <% 
  for(int i=0;i<list.size();i++){
	  Category cate = list.get(i); 
	  String str = "";
		 if(order.getCategoryID().equals(cate.getId()+"")){
			 str = "selected = 'selected'";
		 }
  %>
    <option value="<%=cate.getId()%>"  id="" <%=str %>><%=cate.getName()%></option>
  <%
  }
  %>
  </select>  
  ...
  <tr>
    ...
    <td width="50%" class="">  是
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		否
		<input type="radio" name="Statues" value="0"  checked="checked"/></td>
    <td width="25%"> </td>
  </tr>
  </table>
  ...
  <td width="25%" class="center">票面型号<span style="color:red">*</span></td> 
   ...
   <td width="25%" class="center">送货型号<span style="color:red">*</span></td> 
   <td width="35%" class="">
   <input type="text" name="ordertype0" id="ordertype0" style="width:90% " class="cba"/> 
   </td>    
   <td width="10%" class="center">数量</td>   
  ...
  <div id = "zengpDIV"  >
   ...
   <tr> 
    ...
    <td width="45%" class=""><input class="date2" type="text" value="<%=order.getOdate() %>" name="andate" id ="serviceDate2" placeholder="必填"  readonly="readonly" style="width:90% "></input>   </td>
  ...
  <tr>
    ...
    <td width="25%" class=""><input type="text" style="width:90%;" id="phone2" value="<%=order.getPhone2()==null||order.getPhone2()=="null"?"":order.getPhone2() %>" name="phone2" /></td>
   </tr> 
