<%@ page language="java" import="java.util.*,locate.*,category.*,orderproduct.*,group.*,user.*,utill.*,product.*,order.*;" pageEncoding="UTF-8"  contentType="text/html;charset=utf-8"%>
<!DOCTYPE html>
...
List<OrderProduct> lists = OrderProductManager.getOrderStatues(user, Integer.valueOf(id));
String oplist = StringUtill.GetJson(lists);

String SaleTime = order.getSaleTime();
