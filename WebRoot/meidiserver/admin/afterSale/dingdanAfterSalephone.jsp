...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <input type="submit" class="button" name="dosubmit" value="删除" onclick="deleteed()"></input>   
&nbsp;&nbsp;&nbsp;  
</div>  
...
function deleteed(){ 
	...
	window.location.href="../../AfterSaleServlet?method=del&id="+attract.toString();      
