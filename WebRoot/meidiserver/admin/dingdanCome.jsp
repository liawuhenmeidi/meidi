...
request.setCharacterEncoding("utf-8");
 ...
 SelectOrder sorder = OrderManager.getOrderlist(user,Group.dealSend,Order.come,num,Page,sort,sear); 
...
$(function () {
	...
	$("select[id='numb'] option[value='"+num+"']").attr("selected","selected");
	 $("#page").blur(function(){
		 pages = $("#page").val();
		 window.location.href="dingdanCome.jsp?pages="+pages+"&numb="+num;
	 });
	 ...
	 $("#sort").change(function(){
		...
		// alert(num);  
		 window.location.href="dingdanCome.jsp?page="+pages+"&numb="+num+"&sort="+sort;
	 }); 
...
function serch(){
	 ...
	 window.location.href="dingdanCome.jsp?pages="+pages+"&numb="+num+"&search="+search+"&serchProperty="+serchProperty;
}
...
function winconfirm(){
	...
	if (question != "0"){
		...
		$.ajax({ 
	        type: "post", 
	         url: "server.jsp",
	         data:"method=orderCome&id="+attract.toString(),
	         dataType: "",   
	         success: function (data) {
	        	 if(data == -1){
	        		 ...
	        		 return ;
	        		  ...
	        		  alert("操作成功"); 
	        		  window.location.href="dingdanCome.jsp";
	        	 };	  
	           }, 
