<%@ page language="java" import="java.util.*,category.*,group.*,user.*;" pageEncoding="UTF-8"
...
<div class="main">
    ...
    <div class="">
        <div class="weizhi_head">现在位置：安装公司库存管理</div>
        ...
        <div class="table-list">
            <table width="100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="left"><%=category.getName() %>
                    </td>
                    <td align="left"><%=category.getTime() %>
                    </td>
                    <td align="left">
                        <%
