...
SelectOrder sorder =   OrderManager.getOrderlist(user,Group.sencondDealsend,Order.chargeall,num,Page,sort,sear);  
...
$(function () {
	...
	$("select[id='numb'] option[value='"+num+"']").attr("selected","selected");
	 ...
	 $("#page").blur(function(){
		 pages = $("#page").val();
		 window.location.href="dingdan_chargeall.jsp?pages="+pages+"&numb="+num;
	 });
	 ...
	 $("#sort").change(function(){
		...
		// alert(num);  
		 window.location.href="dingdan_chargeall.jsp?page="+pages+"&numb="+num+"&sort="+sort;
	 }); 
});
	         ...
	         success: function (data) {
	        	 if(data == -1){
	        		 ...
	        		 return ;
	        		  ...
	        		  alert("操作成功");  
	        		  window.location.href="dingdan_chargeall.jsp";
	        	 };	  
	           },  
	         error: function (XMLHttpRequest, textStatus, errorThrown) { 
	        	 alert("服务器忙，请稍后重试"); 
...
<jsp:include flush="true" page="../page.jsp">
	...
	<jsp:param name="type" value="<%=Order.chargeall%>"/> 
</jsp:include>
