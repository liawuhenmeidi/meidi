...
SelectOrder sorder = OrderManager.getOrderlist(user,Group.sencondDealsend,Order.porderPrint,num,Page,sort,"");  
...
$(function () {
	...
	$("select[id='numb'] option[value='"+num+"']").attr("selected","selected");
	 ...
	 $("#page").blur(function(){ 
		 pages = $("#page").val();
		 window.location.href="dingdanprint2anzhuang.jsp?pages="+pages+"&numb="+num;
	 });
	...
	// });
	 ...
	 $("#sort").change(function(){
		...
		// alert(num);  
		 window.location.href="dingdanprint2anzhuang.jsp?page="+pages+"&numb="+num+"&sort="+sort;
	 }); 
});
function func(str){
    $(id).css("display","none");
