...
list = OrderManager.getOrderlist(user,Group.sencondDealsend,Order.dispatch,num,Page,sort,sear);  
count =  OrderManager.getOrderlistcount(user,Group.sencondDealsend,Order.dispatch,num,Page,sort,sear);  
...
$(function () {
	...
	$("select[id='numb'] option[value='"+num+"']").attr("selected","selected");
	 ...
	 $("#page").blur(function(){
		 pages = $("#page").val();
		 window.location.href="dispatch.jsp?pages="+pages+"&numb="+num;
	 });
	 ...
	 $("#sort").change(function(){
		...
		// alert(num);  
		 window.location.href="dispatch.jsp?page="+pages+"&numb="+num+"&sort="+sort;
	 }); 
});
  ...
  %>
    <tr id="<%=o.getId()+"ss" %>"  class="asc"  onclick="updateClass(this)"> 
		...
		<%     
         ...
         <input type="button" onclick="change('songh<%=o.getId()%>','<%=o.getId()%>','<%=Order.orderpeisong %>',<%=substr %>)"  value="确定"/>
		<% }
		} else {
