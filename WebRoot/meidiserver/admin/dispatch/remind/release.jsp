...
list = OrderManager.getOrderlist(user,Group.sencondDealsend,Order.release,num,Page,sort,sear);  
count =  OrderManager.getOrderlistcount(user,Group.sencondDealsend,Order.release,num,Page,sort,sear);  
  ...
  %>
    <tr id="<%=o.getId()+"ss" %>"  class="asc"  onclick="updateClass(this)"> 
		...
		<%      
         ...
         %> 
		   <%=orp.getMessage() %>
		    <input type="button" onclick="changes('<%=o.getId()%>','<%=orp.getId() %>')"  value="同意"/>
		    <input type="button" onclick="changes('<%=o.getId()%>','<%=orp.getId() %>')"  value="不同意"/>
		<%   
		  } 
