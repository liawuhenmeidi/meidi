    ...
    <div class="main_r_a">
        ...
        <div class="table-list">
            <table cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th align="left" width=""><input type="checkbox" value="" id="check_box"
                                                     onclick="selectall('userid[]');"/></th>
                    <th align="left"></th>
                    <th align="left">门店</th>
                ...
                <tr <%=col %>>
                    ...
                    <td align="left"><%=o.getBranch()%>
                    </td>
                    <td align="left"><%=o.getPos() %>
                    </td>
                    <td align="left"><%=o.getSailId() %>
                    </td>
                    <td align="left"><%=o.getCheck() %>
                    </td>
                    <td align="left"><%=o.getUsername() %>
                    </td>
                    <td align="left"><%=o.getPhone1()%>
                    </td>
                    <td align="left"></td>
                    <%
                        String category = "";
                    ...
                    <td align="left"><%=saletype%>
                    </td>
                    <td align="left"><%=countt%>
                    </td>
                    <%
                        String gstatues = "";
                        ;
                    ...
                    <td align="left"><%=gcountt%>
                    </td>
                    <td align="left"><%=gstatues%>
                    </td>
                    <td align="left"><%=o.getSaleTime() %>
                    </td>
                    <td align="left"><%=o.getOdate() %>
                    </td>
                    <td align="left"><%=o.getLocateDetail() %>
                    </td>
                    <td align="left">
                        <%
                    ...
                    <td align="left"><%=usermap.get(Integer.valueOf(o.getSaleID())).getUsername() %>
                    </td>
                    ...
                    <td align="left">
                        ...
                        <select class="category" name="category" id="songh<%=o.getId() %>">
                            ...
                            %>
                            <option value=<%=u.getId() %>  <%= str%>><%=u.getUsername() %>
                            </option>
                            <%
                    ...
                    %>
                    <td align="left"><span style="cursor:hand"
                                           onclick="funcc('ddiv<%=o.getId() %>',<%=o.getId() %>)"></span>
