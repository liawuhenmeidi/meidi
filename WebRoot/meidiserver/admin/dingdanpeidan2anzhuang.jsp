...
<div id="wrap">
    <table cellspacing="1" id="table">
        <tr id="th">
            ...
            <td align="center" width=""><input type="checkbox" value="" id="allselect"
        ...
        <tr id="<%=o.getId()+"ss" %>" class="asc" onclick="updateClass(this)">
            ...
            <td align="center">
                ...
                <input type="button" onclick="change('songh<%=o.getId()%>','<%=o.getId()%>','<%=Order.orderinstall%>')"
                       value="确定"/>
                <%
                } else {
            ...
            <td align="center">
                ...
                <input type="submit" class="button" name="dosubmit" value="释放订单"
                       onclick="winconfirm('<%=o.getId()%>','<%=tatues%>')"></input>
            </td>
            <td align="center">
                <%
                    if (null != opmap.get(OrderPrintln.salereleaseanzhuang)) {
