...
function checkedd(){
    ...
    temp.style.display = "none";
        ...
        opt2.name = 'uploadorder1';      
        opt2.value = '<%=selectOrderName1 %>';            
        temp.appendChild(opt2);  
        
        var opt3 = document.createElement("input");  
        opt3.name = 'uploadorder2';      
        opt3.value = '<%=selectOrderName2 %>';            
        temp.appendChild(opt3);  
        
        var opt4 = document.createElement("input");  
        opt4.name = 'checkBoxStatus';      
        opt4.value = window.opener.getCheckBox();            
