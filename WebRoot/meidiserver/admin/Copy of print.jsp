...
<table width="1000">
  <tr>
    ...
    <td width="300">门店：<%=order.getBranch() %></td>
  </tr>
  <tr>   
    <td>&nbsp;&nbsp;&nbsp;&nbsp;单号：<%=pid+"#" %><%=order.getId() %></td>
    <td><%=time %></td>
  </tr>
...
<table width="1000" border="0" cellpadding="0" cellspacing="0"  id="t">
  <tr>
    ...
    <td width="191" height="35" align="center" valign="middle" id="d"><%=order.getUsername() %></td>
  ...
  <tr>
    <td width="99" height="35" align="center" valign="middle" bgcolor="#FFFFFF" id="d">地&nbsp;&nbsp;&nbsp;&nbsp; 址</td>
    <td height="35" colspan="3" align="center" valign="middle" bgcolor="#FFFFFF" id="d"><%=order.getLocateDetail() %></td>
    <td width="111" height="35" align="center" valign="middle" bgcolor="#FFFFFF" id="d">预约日期</td>
    <td width="223" height="35" bgcolor="#FFFFFF" id="e">&nbsp;<%=order.getOdate() %></td>
  </tr>
  ...
  <td width="10%" height="27" align="center" valign="middle" id="d">产品类别</td>
    <td width="20%" height="27" align="center"  id="d">&nbsp;<%=categorymap.get(Integer.valueOf(op.getCategoryId())).getName() %></td>
    <td width="10%" height="27" align="center" valign="middle" id="d">产品型号</td>
    <td width="20%" height="27" align="center"  id="d">&nbsp;<%=op.getSendType() %></td>
    <td width="10%" height="27" align="center" valign="middle" id="d">数量</td>
    <td width="10%" height="27" align="center" valign="middle" id="d"><%=op.getCount() %></td>
  </tr>	    			 
    ...
    <td width="20%" height="27" align="center" valign="middle" id="d"><%=op.getName() %></td>
    <td width="10%" height="27" align="center" valign="middle" id="d">状态</td>
    <td width="10%" height="27" align="center"valign="middle" id="d"><%=statues %></td>
    <td width="10%" height="27" align="center" valign="middle" id="d">数量</td> 
    <td width="10%" height="27" align="center"valign="middle" id="d"><%=op.getCount() %></td>
  ...
  <tr>
    ...
    <td width="191" height="35" align="center" valign="middle" bgcolor="#FFFFFF" id="d"><%=usermap.get(Integer.valueOf(order.getDealsendId())).getUsername() %></td>
  ...
  <tr>
    ...
    <td height="80" colspan="5" align="right" valign="bottom" bgcolor="#FFFFFF"><%= order.getRemark()%><blockquote>
      <blockquote>
        <blockquote>
          <blockquote>
            <p>顾客签字：</p>
