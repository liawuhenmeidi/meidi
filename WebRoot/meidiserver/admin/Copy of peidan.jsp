<%@ page language="java" import="java.util.*,utill.*,category.*,orderPrint.*,order.*,user.*,orderproduct.*,group.*;"
...
// pos == "" || pos == null || pos == "null"
    ...
    if (StringUtill.isNull(str)) {
        ...
        list = OrderManager.getOrderlist(user, Group.sencondDealsend, str);
    }
...
<div class="s_main">
    ...
    <!--  头 单种类  -->
    <div class="s_main_tit">配单<span class="qiangdan"><a href="server.jsp?method=quit">退出</a></span><span
            class="qiangdan"><a href="chaxun_peidan.jsp">查询</a></span></div>
    ...
    <div class="s_main_box">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_main_table">
            ...
            <tr>
                ...
                <td width="30%" id="lt" class="red">
                    <div id="div<%=o.getId()%>">
                        <table>
                            ...
                            %>
                            <tr>
                                <td align="left"><%=categorymap.get(op.getCategoryId()).getName()%>
                                </td>
                                <td align="left"><%=op.getSendType()%>
                                </td>
                            </tr>
                            <%
                                }
                ...
                <td width="30%" id="ltr" class="red"><%=o.getOdate() %>
                </td>
            </tr>

            <tr>
                <td width="20%" id="lt">地址：</td>
                <td colspan="3" id="ltr" class="red"><%=o.getLocateDetail() %>
                </td>
            </tr>
