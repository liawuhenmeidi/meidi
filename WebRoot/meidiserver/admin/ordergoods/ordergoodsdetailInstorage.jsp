	  ...
	  var str = '<tr '+cl+' id="'+json.id+'">' +    
	     ...
	     if(json.statues == 6 || json.statues == 7 || json.statues == 8 || json.statues == 9){ 
	    	//alert(json.statues); 
	    	 str += '<td align=center >'+ 
	    	 '</td> '+  
	    		 '<td align=center  bgcolor="red">'+ json.returnrealsendnum+  
	    ...
	    // '<input type="hidden" name="id" value='+json.id+'>'+
		 	...
		 	str +=     ' <td align=center   ><input type="checkbox" name="ogid"  value="'+json.id+'" id="check_box" onclick="changecolor(this)"></td> '+   
		 	 '<td align=center>'+     
			    // '<input type="hidden" name="id" value='+json.id+'>'+
			     '<input type="text" name="realsendnum'+json.id+'" id="realsendnum'+json.id+'" value='+json.realsendnum+'>'+
			     '</td> ' ;  
...
<div class="main">  
   ...
   <ul>                                                                                                             
    ...
    <form action="../../user/OrderGoodsServlet"  method = "post"  onsubmit="return check()">
       <input type="hidden" name="method" value="updaterealInstoragenum"/>   
      ...
      <table style="width:100% " >  
       ...
       <td colspan=5 align=center>  
        <table   style="width:100% "  id="Ntable" >
         <tr class="dsc">     
           ...
           <td align=center width="10%"> 订货数</td>
            <td align=center width="10%">实收货数量</td> 
           <td align=center width="10%" bgcolor="red">退货数量</td>  
           <td align=center width="5%" ><input 
						type="checkbox" value="" id="allselect"
						onclick="seletall(allselect)"></input></td> 
			<td align=center width="20%" >卖场入出库数量</td>  
          </tr> 
        </table> 
       </td>
       ...
       <font style="color:blue;font-size:20px;" >
          ...
          -->                   
       <td align=center colspan=5>  备注：<input id="remark" name="remark" value="<%=remark%>"></input></td>
       </tr>
