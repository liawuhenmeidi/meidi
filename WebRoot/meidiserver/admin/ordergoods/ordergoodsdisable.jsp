...
Branch b = BranchService.getMap().get(Integer.valueOf(branch));
 ...
 function addrow(row){ 
	 var cl = 'class="asc"'; 
	  ...
	  var str = '<tr '+cl+'>' +    
	     ...
	     '</tr>'+     
	     '<tr '+cl+' ><td colspan=7 align=center ><table id="table'+row+'" width="100%"></table></td></tr>'
	     ;  
	...
	<div class="main">
		...
		<div>
			<form action="../../user/OrderGoodsServlet" method="post" id="mypost">
				<input type="hidden" name="method" value="disableadd" /> <input
