<%@ page language="java"  import="java.util.*,ordersgoods.*,product.*,branchtype.*,org.apache.commons.logging.*,utill.*,category.*,orderPrint.*,order.*,user.*,orderproduct.*,group.*,aftersale.*;" pageEncoding="UTF-8"  contentType="text/html;charset=utf-8"%>
<%   
...
<td >产品状态：       
  <input type="checkbox" name="statues" value="1">常规机
  <input type="checkbox" name="statues" value="2">特价
  <input type="checkbox" name="statues" value="3">样机
  <input type="checkbox" name="statues" value="4">换货
  <input type="checkbox" name="statues" value="5">赠品
  <input type="checkbox" name="statues" value="6">店外退货
  <input type="checkbox" name="statues" value="7">已入库常规退货
  <input type="checkbox" name="statues" value="8">已入库特价退货
  <input type="checkbox" name="statues" value="9">已入库样机退货
</td>
</tr>
</table>
</td>
  ...
  <tr class="dsc"> 
   <td width="5%" class="s_list_m"  align="center"><input type="checkbox" value="" id="allselect" onclick="seletall(allselect)"></input></td>
  ...
  %>              
 <tr class="asc" ondblclick="detail('ordergoodsdetail.jsp?id=<%=key%>&type=<%=OrderMessage.examine%>&statues=<%=OrderMessage.unexamine%>')">   
    ...
    <td align="center" colspan=5>
       <input type="button"  value="生成订单" onclick="check(0)"  />
       <input type="button"  value="生成退货单" onclick="check(1)" />
       <input type="button"  value="忽略" onclick="check(2)"  /></td> 
    </tr>
</table>
</form>
