...
public class inventoryOrderModel {
	protected static Log logger = LogFactory.getLog(inventoryOrderModel.class);
	...
	public static boolean getinventoryOut(String starttime, String endtime,
		...
		try { 
			...
			URI uri = new URI(inventoryOrderModel.url);
	...
	public static void get(String starttime, String endtime) {
		...
		try {
			...
			OrderReceitManager.saveOutModel(reader, starttime, endtime);
			reader.close();
		} catch (IOException e) {
			// TODO Auto-generated catch block
			logger.info(e);
	...
	public static boolean getinventoryOutModel(String starttime,
		...
		try {
			logger.info("getinventoryOrder");
			URI uri = new URI(inventoryOrderModel.urlModel);
