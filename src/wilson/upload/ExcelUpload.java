...
public class ExcelUpload extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		suningFilePath = sc.getRealPath("/")
				+ config.getInitParameter("suningFilePath");
		salaryFilePath = sc.getRealPath("/")
				+ config.getInitParameter("salaryFilePath");
		salesFilePath = sc.getRealPath("/")
				+ config.getInitParameter("salesFilePath");
		changeFilePath = sc.getRealPath("/")
				+ config.getInitParameter("changeFilePath");
		productFilePath = sc.getRealPath("/")
				+ config.getInitParameter("productFilePath");
		productFilePath = sc.getRealPath("/")
				+ config.getInitParameter("productFilePath");
	}
	...
	public void uploadOnly(HttpServletRequest req, HttpServletResponse res) {
	...
	public void direct(HttpServletRequest req, HttpServletResponse res){
		...
		String  t = req.getParameter("categoryID");
		String directUrl = "";
		String filePath = "";
		String parame = "";
